...
async function testRegister() {
  ...
  let output = "=== Testing Register API ===\n";
  output += "URL: https://backend.jobryn.com/api/v1/account/register/\n";
  ...
  fs.writeFileSync('test_register_output.txt', output);
  console.log("Done - check test_register_output.txt");
}
