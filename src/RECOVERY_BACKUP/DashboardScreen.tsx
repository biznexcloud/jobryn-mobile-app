    ...
    <ScreenWrapper safeAreaTop={false} backgroundColor={FB_GRAY}>
      ...
      <Box px={16} pt={insets.top + 4} pb={12} bg="white">
         <HStack items="center" justify="space-between">
            <Text fontSize={28} fontWeight="900" color={FB_BLUE} letterSpacing={-1}>jobryn</Text>
            <HStack space="md">
      ...
      >
        ...
        <Box bg="white" p={12} borderBottom={1} borderColor="#E5E7EB">
           <HStack items="center">
              ...
              >
                 <Text color="#666666" fontSize={14}>What's on your mind?</Text>
              </TouchableOpacity>
           ...
           <HStack justify="space-around">
              <TouchableOpacity style={styles.shortcut}><Video size={20} color="#F3425F" /><Text fontSize={12} fontWeight="700" color="#666666" ml={6}>Live</Text></TouchableOpacity>
              <TouchableOpacity style={styles.shortcut}><ImageIcon size={20} color="#45BD62" /><Text fontSize={12} fontWeight="700" color="#666666" ml={6}>Photo</Text></TouchableOpacity>
              <TouchableOpacity style={styles.shortcut}><Smile size={20} color="#F7B928" /><Text fontSize={12} fontWeight="700" color="#666666" ml={6}>Feeling</Text></TouchableOpacity>
           </HStack>
        </Box>
           ...
           <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 16 }}>
              ...
              <TouchableOpacity style={styles.storyCard} onPress={() => navigation.navigate('CreateStory')}>
                 ...
                 <View style={styles.storyFooter}>
                    <Text fontSize={11} fontWeight="700" color="black" textAlign="center" mt={16}>Create Story</Text>
                 </View>
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  storyCard: { width: 106, height: 188, marginRight: 8, backgroundColor: 'white', borderRadius: 12, overflow: 'hidden', borderWidth: 1, borderColor: '#E5E7EB' },
  storyThumb: { width: '100%', height: 130, backgroundColor: '#F0F2F5' },
  storyImg: { width: '100%', height: '100%', opacity: 0.8 },
  storyImgFull: { width: '100%', height: '100%' },
  addStoryBtn: { position: 'absolute', bottom: -16, alignSelf: 'center', width: 32, height: 32, borderRadius: 16, backgroundColor: FB_BLUE, alignItems: 'center', justifyContent: 'center', borderWidth: 3, borderColor: 'white' },
  storyFooter: { flex: 1, justifyContent: 'center', backgroundColor: 'white' },
